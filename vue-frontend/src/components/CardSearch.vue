<template>
    <template v-for="user in info" :key="user.id">
    <div class="block unread" @click="fromSearch(user.username)">
                <div class="imgbx">
...
<script>
    export default {
        ...
        methods: {
            fromSearch(username) {
                this.$store.state.isFromSearch = true
